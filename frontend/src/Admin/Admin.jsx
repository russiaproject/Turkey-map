...
const Admin = () => {
  ...
  const handlePublicationSubmit = async (e) => {
    ...
    if (!newPublication.title || !newPublication.authors || !newPublication.type || 
        !newPublication.shortAbstract || !newPublication.description) {
  ...
  // Rus İzi fonksiyonları (mevcut kodlar...)
