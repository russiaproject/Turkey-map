...
const Konsolosluklar = () => {
          ...
          <div className="mt-5 fotoKonsolosluklarHepsi">
            ...
            <div>
              <p>
                ...
                <br />
                <span className="fw-bold">E-Mail:</span> stambul@mid.ru 
              </p>
            </div>
          </div>
          {/* Ankara */}
  ...
  <br />
  <span className="fw-bold">E-Mail:</span> ankarakons@yandex.ru
  <br />
  ...
  <br />
  <span className="fw-bold">E-Mail:</span> ruskonsant@yandex.ru
</p>
            </div>
          </div>
          {/* trabzon */}
  ...
  <br />
  <span className="fw-bold">Telefonları:</span> ‪+90-462-326-26-00‬
  <br />
  ...
  <br />
  <span className="fw-bold">E-posta:</span> trabzon@yandex.ru
  <br />
  <span className="fw-bold">Web sitesi:</span> https://trabzon.mid.ru
</p>
            </div>
          </div>
