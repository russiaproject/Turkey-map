...
import rusIzleriData from './data/rus_izleri.json'; // ✅ Lokal JSON kullan
...
const RusIzleri = () => {
  ...
  // ✅ Lokal data kullan - sadece error state'i kalsın
  ...
  useEffect(() => {
    if (Object.keys(plakaToCity).length > 0 && Object.keys(rusIzleriData).length > 0) {
  ...
  const getMarkerColor = (type) => {
    switch(type) {
      ...
      case 'Kullanıcı Katkısı': return '#9370DB';
              ...
              {selectedRusIzi ? (
                <>
                  ...
                  <div className="text-center mb-4">
                    ...
                    {selectedRusIzi.userContribution && (
                      <div className="mt-2">
                    ...
                    {getRusIzleriList().map((rusIzi, index) => (
                      ...
                      >
                        ...
                        <div className="rusizi-item-info">
                          <div className="rusizi-item-name">
                            {rusIzi.name}
          ...
          >
            ...
            <div className="map-legend">
              ...
              <div className="legend-item">
                ...
                <span className="legend-label">Kullanıcı Katkısı</span>
              </div>
