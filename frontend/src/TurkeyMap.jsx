                            ...
                            {selectedInstitution ? (
                                ...
                                <>
                                    <div className="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <span className="badge institution-count-badge me-4">
                                            {getInstitutionsList().length} adet
                                        </span>
                                    </div>
                        ...
                        <div className='d-flex justify-content-center'>
                            <div className="map-legend">
                                ...
                                <div className="legend-item">
                                    ...
                                    <span className="legend-label">Resmi Kurum (Elçilik, Konsolosluk, Rusevi)</span>
                                </div>
                                <div className="legend-item">
                                    <span className="legend-color" style={{ backgroundColor: '#0032A0' }}></span>
                                    <span className="legend-label">Ticari ve Kültürel</span>
                                </div>
                                <div className="legend-item">
                                    <span className="legend-color" style={{ backgroundColor: '#5C9E31' }}></span>
                                    <span className="legend-label">Üniversite</span>
                                </div>
                                <div className="legend-item">
                                    <span className="legend-color" style={{ backgroundColor: '#525252' }}></span>
