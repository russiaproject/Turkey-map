...
import ludmila from "./images/RussiaFlag.svg";

const Credit = () => {
  return (
    <div className="container p-5">
      <div className="text-center mb-5">
        <h2 className="mb-4 normalBaslik">Ekibimiz</h2>
        <p className="text-muted mb-4">Rus Evi Ankara projesini hayata geçiren ekibimizle tanışın.</p>
        <Link to="/apply" className="btn btn-primary btn-lg px-4 py-2 rounded-pill shadow-sm">
          <i className="fa-solid fa-user-plus me-2"></i>
          Geliştirme Ekibine Başvur
        </Link>
      </div>
